...
class TextFAST(object):
    ...
    def __init__(self,
        ...
        # Step var to track while training
        ...
        def _linear(input_,
            ...
            Raises:
                ValueError: if some of the arguments has unspecified or
                wrong shape.
            """
        ...
        def _highway_layer(input_,
            ...
            t = sigmoid(Wy + b)
            z = t * g(Wy + b) + (1 - t) * y
            where g is non-linearity, t is transform gate, and (1 - t) is
            carry gate.
            """
            ...
            for idx in range(num_layers):
                ...
                t = tf.sigmoid(_linear(input_, size, scope=(
                    "highway_gate_{0}".format(idx))) + bias)
        ...
        with tf.device("/cpu:0"), tf.name_scope("embedding"):
            ...
            # Can also be obtained through our own word vectors
            # trained by our corpus
        ...
        # Average Vectors
        self.embedded_sentence_average = tf.reduce_mean(self.embedded_sentence,
                                                        axis=1)
