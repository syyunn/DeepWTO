...
class TextANN(object):
    """An ANN for text classification."""
    ...
    def __init__(
        ...
        def _highway_layer(input_,
            ...
            t is transform gate, and (1 - t) is carry gate.
            """
        ...
        with tf.name_scope("fc"):
            W = tf.Variable(
                tf.truncated_normal(shape=[embedding_size,
                                           fc_hidden_size],
                                    stddev=0.1,
                                    dtype=tf.float32),
                name="W")
            ...
            # Apply nonlinearity
            self.fc_out = tf.nn.relu(self.fc_bn,
                                     name="relu")
        ...
        with tf.name_scope("dropout"):
            self.h_drop = tf.nn.dropout(self.highway,
