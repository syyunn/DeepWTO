...
### Achievement
The model has achieved `AUC-ROC 0.8432` in one-label-classification task with test data. 
Please refer to the [cite_wa](https://drive.google.com/open?id=100DJ0QXyG89HZzB4w2Cbyf4xjNK54cQ1). 
